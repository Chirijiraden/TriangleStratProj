...
#include "MainMenu_SaveLoad_List_Button.generated.h"

class UTexture2D;

UCLASS(Blueprintable, EditInlineNew)
class NEWERA_API UMainMenu_SaveLoad_List_Button : public UCommonBaseWidget {
    GENERATED_BODY()
public:
protected:
...
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    UTexture2D* screenShotTex;
    
public:
    UMainMenu_SaveLoad_List_Button();
};
