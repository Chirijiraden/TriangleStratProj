...
#include "EShopCategory.h"
#include "EFaithType.h"
#include "Engine/DataTable.h"
#include "GOP_Shop_ListTable.generated.h"

USTRUCT(BlueprintType)
struct FGOP_Shop_ListTable : public FTableRowBase {
    GENERATED_BODY()
public:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FName ItemBattleRecId;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    FName AccessoryRecId;
    ...
    NEWERA_API FGOP_Shop_ListTable();
};
