...
UCriWarePluginSettings::UCriWarePluginSettings() {
    ...
    this->ContentDir = TEXT("Newera/Sound/Stream");
    this->NumBinders = 1024;
    this->MaxBinds = 1024;
    this->NumLoaders = 1024;
    this->MaxPath = 1024;
    ...
    this->NumStandardStreamingVoices = 14;
    ...
    this->MaxDecoderHandles = 8;
    this->MaxManaBPS = 57800;
